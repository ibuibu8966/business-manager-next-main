    ...
    <AppLayout title="ダッシュボード">
      ...
      <div className="dashboard-grid">
        ...
        <div className="stat-card">
          <div className="stat-icon">💳</div>
          <div className="stat-info">
            <span className="stat-value" style={{ fontSize: '18px', whiteSpace: 'nowrap' }}>¥{totalAccountBalance.toLocaleString()}</span>
            <span className="stat-label">口座残高合計</span>
            <div style={{ marginTop: '4px', fontSize: '10px', display: 'flex', gap: '6px', whiteSpace: 'nowrap' }}>
